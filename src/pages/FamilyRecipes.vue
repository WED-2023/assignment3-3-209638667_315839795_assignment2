            ...
            <div v-for="recipe in recipes" :key="recipe.recipeId" class="recipe-card">
                ...
                <div class="recipe-content">
                    ...
                    <div class="dietary-badges">
                        ...
                        <span v-if="recipe.isVegetarian" class="badge vegetarian">Vegetarian</span>
                        <span v-if="recipe.isGlutenFree" class="badge gluten-free">Gluten-Free</span>
                    </div>
            ...
            <div class="modal-content" @click.stop>
                ...
                <div class="modal-header">
                    ...
                    <div class="modal-family-info">
                        <p><strong>From {{ selectedRecipe.whoMadeIt }}</strong></p>
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-meta">
                        <span v-if="selectedRecipe.cookTime">⏱️ {{ selectedRecipe.cookTime }} minutes</span>
                        <span v-if="selectedRecipe.servings">👥 Serves {{ selectedRecipe.servings }}</span>
                        <div class="modal-dietary">
                            <span v-if="selectedRecipe.isVegan" class="badge vegan">Vegan</span>
                            <span v-if="selectedRecipe.isVegetarian" class="badge vegetarian">Vegetarian</span>
                            <span v-if="selectedRecipe.isGlutenFree" class="badge gluten-free">Gluten-Free</span>
                        </div>
                    </div>
                    ...
                    <div class="recipe-details">
                        <div class="ingredients-section">
                            <h3>Ingredients</h3>
                            <ul>
                                <li v-for="(ingredient, index) in parseIngredients(selectedRecipe.ingredients)"
                                    :key="index">
                                    {{ ingredient }}
                                </li>
                            </ul>
                        ...
                        <div class="instructions-section">
                            <h3>Instructions</h3>
                            <ol>
                                <li v-for="(instruction, index) in parseInstructions(selectedRecipe.instructions)"
                                    :key="index">
                                    {{ instruction }}
                                </li>
                            </ol>
